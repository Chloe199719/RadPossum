...
export default async function handler(
  ...
  try {
    ...
    const lesson = await prismaClient.lessons.update({
      where: {
        id: req.body.id as string,
      },
      data: {
        lessonTitle: req.body.title as string,
        notes: req.body.notes as string,
        homework: req.body.homework as string,
        recording: req.body.recording as string,
      },
    });
